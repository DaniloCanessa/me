  ...
  return (
    <>
      ...
      <button
        ...
        className="w-full rounded-xl border-2 border-gray-200 hover:border-green-300 bg-white text-gray-700 font-semibold py-3 text-sm transition-colors flex items-center justify-center gap-2"
      >
