...
export default async function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {/* Halo pulsante para llamar la atención (respeta reduced-motion) */}
      <span
        aria-hidden="true"
        className="absolute inset-0 rounded-full bg-[#25d366]/60 motion-safe:animate-ping [animation-duration:2s]"
      />
      <a
        href={href}
        target="_blank"
        ...
        className="group relative flex items-center gap-0 rounded-full bg-[#25d366] text-white shadow-xl shadow-[#25d366]/50 ring-2 ring-white/40 transition-all duration-300 hover:shadow-2xl hover:shadow-[#25d366]/60 hover:scale-105"
      >
