...
> Última actualización: 24 de junio 2026 (sesión 30 — **módulo tributario F29 completo**: facturas de venta, planilla F29 desde el RCV del SII, ciclo anticipo→factura, Conciliación SII bidireccional, registro de gasto general + activo fijo, verificación del remanente, balance anual / pre-balance + honorarios + export a Excel. 13 commits **SIN PUSHEAR** — `1876a13`…`a7399bd`. Datos 2026 ene–may + F29 oficial cargados. Sesión 29 — simulador PFV existente + fotos comprimidas [desplegado])
...
**▶ PARA RETOMAR (sesión 30/31):**
1. **DESPLEGAR el módulo tributario F29** (`actualiza vercel`): hay **13 commits locales sin pushear** (`1876a13`, `5bd571b`, `6d2090d`, `2df6e5e`, `6ae247d`, `5a53bb3`, `6acd8ad`, `c7972bf`, `42708fc`, `a7399bd` + el de esta doc). **Las 8 migraciones ya están corridas en Supabase** (`sales_invoices`, `f29_periods`, `anticipo_factura_cycle`, `sii_rcv`, `balance_anual`, `gasto_activo_fijo`, `f29_oficial`). El usuario estaba revisando en local antes de desplegar.
...
**Desarrollos sesión 30 (21-24 junio 2026) — MÓDULO TRIBUTARIO F29 + balance anual (13 commits SIN PUSHEAR; 8 migraciones ya corridas):**
