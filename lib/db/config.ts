...
const DEFAULTS: SimulatorConfig = {
  ...
  dayConsumptionRatioBusiness: SOLAR_DEFAULTS.businessDayConsumptionRatio,
...
export async function getSimConfig(): Promise<SimulatorConfig> {
  try {
    ...
    return {
      ...
      dayConsumptionRatioBusiness: map['simulator.day_consumption_ratio_business'] ?? DEFAULTS.dayConsumptionRatioBusiness,
