...
> Última actualización: 16 de junio 2026 (sesión 27 — correo diario de licitaciones + respaldo de cron por GitHub Actions + preview/lightbox de boletas en gastos + extrapolación estacional del consumo residencial, verificada en la UI + fix de coherencia del Paso de revisión)
