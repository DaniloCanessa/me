...
> Última actualización: 17 de junio 2026 (sesión 28 — "Atención a" en clientes + RUT/atención en el PDF de cotización [desplegado]; simulador: lógica de PFV existente — saldo de empalme / complemento / mantención [implementado, en revisión del usuario])
