...
- **Cambio de dominio a `www.mercadoenergy.cl` EN VIVO (commit `5b4d522`):** DNS editado en HostGator (apex A `216.198.79.1`, www CNAME `81ad3f5d52b0cd8b.vercel-dns-017.com`), correo Titan preservado, 301 del `.vercel.app` al dominio, 301 del sitio viejo activas. Ver detalle en "próximo paso" arriba. Pendiente del usuario: Search Console + Bing + sitemap, reinstalar PWA, verificar dominio en Resend
